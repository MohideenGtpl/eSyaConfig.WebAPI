    ...
    public class CountryRepository : ICountryRepository
    {
                ...
                using (var dbContext = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (countrycode._lstUIDpattern !=null)
                        {
                            ...
                            {
                                var isExits = db.GtEccnpi.Where(x => x.Isdcode == p.Isdcode && x.Uidlabel.Trim().ToUpper() == p.Uidlabel.Trim().ToUpper()).FirstOrDefault();
                                if (isExits == null)
                                {
                    ...
                    try
                    {
                       ...
                       // ctr.Uidpattern = countrycode.Uidpattern;
                        ...
                        if (countrycode._lstUIDpattern !=null)
                        {
                            foreach (var p in countrycode._lstUIDpattern)
                            {
                                var uidpattern = db.GtEccnpi.Where(x => x.Isdcode == p.Isdcode && x.Uidlabel.Trim().ToUpper() == p.Uidlabel.Trim().ToUpper()).FirstOrDefault();
                                if (uidpattern != null)
                                {
        ...
        public async Task<List<DO_UIDPattern>> GetUIDPatternbyIsdcode(int Isdcode)
        {
            try
            {
                ...
                {
                    var Uidpatterns = db.GtEccnpi.Where(x => x.Isdcode == Isdcode)
